...
#data.table::fwrite(median_ens, here("data", "processed", "median_ensemble.csv"))

data.table::fwrite(median_ens |> mutate(model = "median-hubreplica"), here("data", "processed", "hubreplica-ensemble.csv"))
